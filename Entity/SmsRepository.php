 ...
 * Class SmsRepository.
 */ 
namespace MauticPlugin\MauticTextLocalSmsBundle\Entity; 
 ...
 class SmsRepository extends CommonRepository {
    ...
    public function getEntities(array $args = [])
    {
        $q = $this->_em
            ...
            ->from('MauticTextLocalSmsBundle:Sms', $this->getTableAlias(), $this->getTableAlias().'.id');
    ...
    public function getSentCount()
    {
        ...
        $q->select('SUM(e.sentCount) as sent_count')
            ->from('MauticTextLocalSmsBundle:Sms', 'e');
