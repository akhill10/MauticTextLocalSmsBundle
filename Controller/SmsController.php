...
namespace MauticPlugin\MauticTextLocalSmsBundle\Controller;

use Mautic\CoreBundle\Controller\FormController;
use Mautic\CoreBundle\Helper\InputHelper;
use Mautic\LeadBundle\Controller\EntityContactsTrait;
use MauticPlugin\MauticTextLocalSmsBundle\Entity\Sms;
...
class SmsController extends FormController
{
    ...
    {
        /** @var \MauticPlugin\TextLocalSmsBundle\Model\SmsModel $model */
        ...
        if ($count && $count < ($start + 1)) {
            ...
            return $this->postActionRedirect([
                ...
                'contentTemplate' => 'MauticTextLocalSmsBundle:Sms:index',
                'passthroughVars' => [
        ...
        $integration = $this->get('mautic.helper.integration')->getIntegrationObject('TextLocal');
        ...
        return $this->delegateView([
            ...
            'contentTemplate' => 'MauticTextLocalSmsBundle:Sms:list.html.php',
            'passthroughVars' => [
                'activeLink'    => '#mautic_sms_index',
                'mauticContent' => 'sms',
    ...
    public function viewAction($objectId)
    {
        ...
        /** @var \MauticPlugin\TextLocalSmsBundle\Entity\Sms $sms */
        ...
        return $this->delegateView([
            ...
            'viewParameters' => [
                ...
                'contacts'    => $this->forward(
                    'MauticTextLocalSmsBundle:Sms:contacts',
                    [
                        'objectId'   => $sms->getId(),
            ...
            'contentTemplate' => 'MauticTextLocalSmsBundle:Sms:details.html.php',
            'passthroughVars' => [
                'activeLink'    => '#mautic_sms_index',
                'mauticContent' => 'sms',
            ],
    ...
    public function newAction($entity = null)
    {
        ...
        if (!$entity instanceof Sms) {
            /** @var \MauticPlugin\TextLocalSmsBundle\Entity\Sms $entity */
            ...
            if (!$cancelled = $this->isFormCancelled($form)) {
                if ($valid = $this->isFormValid($form)) {
                    ...
                    if ($form->get('buttons')->get('save')->isClicked()) {
                        ...
                        $template  = 'MauticTextLocalSmsBundle:Sms:view';
                    } else {
                ...
                $template       = 'MauticTextLocalSmsBundle:Sms:index';
        ...
        return $this->delegateView(
            [
                'viewParameters' => [
                    'form' => $this->setFormTheme($form, 'MauticTextLocalSmsBundle:Sms:form.html.php', 'MauticTextLocalSmsBundle:FormTheme\Sms'),
                    'sms'  => $entity,
                ],
                'contentTemplate' => 'MauticTextLocalSmsBundle:Sms:form.html.php',
                'passthroughVars' => [
                    'activeLink'    => '#mautic_sms_index',
                    'mauticContent' => 'sms',
    ...
    public function previewAction($objectId)
    {
        ...
        if ($sms !== null && $security->hasEntityAccess('sms:smses:viewown', 'sms:smses:viewother')) {
            return $this->delegateView([
                ...
                'contentTemplate' => 'MauticTextLocalSmsBundle:Sms:preview.html.php',
            ]);
        }
